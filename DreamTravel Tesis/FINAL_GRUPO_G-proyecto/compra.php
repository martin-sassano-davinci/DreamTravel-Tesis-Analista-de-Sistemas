                        ...
                        <div class="card-body">
                          <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center">
                              <div>
                                <img
                                  src="img/paquete(cancun).png"
                                  class="img-fluid rounded-3" alt="Shopping item" style="width: 150px;">
                              </div>
                              <div class="ms-3">
                                <h5>Cancún, MÉXICO</h5>
                                <p class="small text-muted cat">   <i class="fas fa-plane"></i> Incluye aéreos. <br>
                                  <i class="fas fa-bed"></i> Incluye hospedaje. <br>
                                  <i class="fas fa-utensils"></i> Desayuno / almuerzo / cena. <br>
                                  <i class="bi bi-people-fill"></i> 4 personas</p>
                              </div>
                            </div>
                            <div class="d-flex flex-row align-items-center">
                        ...
                        <div class="card-body">
                          <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center">
                              <div>
                                <img
                                  src="img/paquete(china).png"
                                  class="img-fluid rounded-3" alt="Shopping item" style="width: 150px;">
                              </div>
                              <div class="ms-3">
                                <h5>Gran Muralla China, CHINA</h5>
                                <p class="small text-muted cat">   <i class="fas fa-plane"></i> Incluye aéreos. <br>
                                  <i class="fas fa-bed"></i> Incluye hospedaje. <br>
                                  <i class="fas fa-utensils"></i> Desayuno / almuerzo / cena. <br>
                                  <i class="bi bi-people-fill"></i> 4 personas</p>
                    ...
                    <div class="col-lg-5">
                      ...
                      <div class="card bg-secondary text-white rounded-3">
                        <div class="card-body">
                          ...
                          <button type="button" class="btn btn-info btn-block btn-lg btn-warning">
                            <div class="d-flex justify-content-between">
                              <span>$4818.00 </span>
